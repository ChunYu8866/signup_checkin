...
const privacyNoticeUrl = safeHttpsUrl(localTest?.privacyNoticeUrl ?? APP_CONFIG.privacyNoticeUrl ?? '');
const hasPrivacyNotice = Boolean(privacyNoticeUrl || privacyNoticeText.trim());
